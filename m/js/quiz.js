...
var resultOptions = [
    {   title: '<img src="http://wecyd.com/nts/answer_list2.png"><br/><br/>',
        desc: '<p><a href="javascript:;" class="reset"><img src="http://wecyd.com/nts/re_test_btn2.png" style="width:80%;" data-dismiss="modal"></a></p>'
    },
        ...
        // while (n < 3) {
         //   increment = minScore + (interval * n);
            if (totalScore < 10) {
                ...
                resultsTitle.replaceWith('<h1><img src="http://wecyd.com/nts/event_db_title2.png"></h1>');
                resultsDesc.replaceWith('<p class="desc"><input type="text" name="name1" id="name1" onkeyup="onlyKorean(this);" maxlength="5" placeholder="이름"/></p><p class="tel-1"><input type="tel" name="tel1" id="tel1" class="tel-check" onkeydown="return onlyNumber(event)" onkeyup="removeChar(event)" maxlength="11" placeholder="연락처"/></p><p class="select_displaynone2"><input name="radio2" id="radio2" type="radio" value="전자세금계산서_전자">전자세금계산서_전자</p><p class="select_displaynone2"><input name="radio2" id="radio2" type="radio" value="현금영수증_전자" checked="checked">현금영수증_전자</p><p class="check_01"><label for="agree"><input type="checkbox" id="agree1-1" name="agree1-1" checked="checked"/>개인정보 수집 및 이용에 동의합니다.</label></p><p class="check_01"><label for="agree"><input type="checkbox" id="agree1-2" name="agree1-2" checked="checked"/>마케팅수신동의</label></p><p class="quiz_com_btn"><a onclick="input_db(1)"><img src="http://wecyd.com/nts/complete_btn2.png"></a></p>');
                return;
            }
        //}
    }
